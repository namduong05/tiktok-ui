...
export const UserFollowingIcon = ({ className }) => (
    <svg
        className={className}
        fill="currentColor"
        width="3.2rem"
...
export const UserFollowingActiveIcon = ({ className }) => (
    <svg
        className={className}
        fill="currentColor"
        width="3.2rem"
...
export const UserFriendIcon = ({ className }) => (
    <svg
        className={className}
        width="3.2rem"
        data-e2e=""
...
export const UserFriendActiveIcon = ({ className }) => (
    <svg
        className={className}
        width="32"
        data-e2e=""
...
export const AddFollowerIcon = ({ className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const SaveVideoIcon = ({ className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="24"
...
export const ShareVideoIcon = ({ className }) => (
    <svg
        className={className}
        xmlns="http://www.w3.org/2000/svg"
        width="24"
